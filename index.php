...
<body>
  ...
  <div class="section grey lighten-3">
    <div class="row container">
      <h2 class="header">Dan Scott - Welcome</h2>
      <!-- <div>Icons made by <a href="http://www.freepik.com" title="Freepik">Freepik</a> from <a href="http://www.flaticon.com" title="Flaticon">www.flaticon.com</a> is licensed by <a href="http://creativecommons.org/licenses/by/3.0/" title="Creative Commons BY 3.0" target="_blank">CC 3.0 BY</a></div> -->
      <p class="grey-text text-darken-3 lighten-3">Welcome to my website, as you can see this is currently in development. I have a temporary website that I could show,
  ...
  <div class="section blue-grey lighten-5">
    <div class="row container">
      <h2 class="header">Latest Web project</h2>
      <p class="grey-text text-darken-3 lighten-3"><a href="UK-Cycling-Events/index.php">Click here</a> to check out my latest (and only) web project</p>
    </div>
  </div>
